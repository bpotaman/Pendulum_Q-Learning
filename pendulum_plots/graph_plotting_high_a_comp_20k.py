...
class ManimGraph(Scene):
    def construct(self):
        ...
        with open(r"graphs\graph_a_02_20k.pkl", "rb") as f:
            dataset1 = np.load(f, allow_pickle=True)
        
        x1 = dataset1[0][0::5]
        y1 = dataset1[1][0::5]

        with open(r"graphs\graph_a_03_20k.pkl", "rb") as f:
            dataset2 = np.load(f, allow_pickle=True)

        x2 = dataset2[0][0::5]
        y2 = dataset2[1][0::5]

        with open(r"graphs\graph_a_04_20k.pkl", "rb") as f:
            dataset2 = np.load(f, allow_pickle=True)
        ...
        t1 = MathTex(r"\alpha = 0.2")
        t2 = MathTex(r"\alpha = 0.3")
        t3 = MathTex(r"\alpha = 0.4")
